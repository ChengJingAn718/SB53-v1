...
let titleAudio = new loadSound('SB_53_Audio_01');
let bodyAudio = new loadSound('SB_53_Audio_10');
let subBodyAudio = new loadSound('SB_53_Audio_03');
...
let repeatAudio = new loadSound('SB_53_Audio_10')

let henNormalAudio = new loadSound('henfeed')
let henFeedAudio = new loadSound('hennormal')

let henCrowdAudio = new loadSound('hencrowd')
...
let audioListForMute = [
    ...
    repeatAudio, henNormalAudio, henFeedAudio, henCrowdAudio
]
var isOff = false;
